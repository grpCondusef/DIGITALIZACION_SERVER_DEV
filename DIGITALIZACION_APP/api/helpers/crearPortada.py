...
def get_expedient_data(clave, expediente, vigencia_ids, valoresDocumentales_array, serie_id):
        ...
        expediente_data['vigenciaTramiteAnios'] = vigenciaTramite.get('anios')
        expediente_data['vigenciaTramiteMeses'] = vigenciaTramite.get('meses')
        expediente_data['vigenciaTramiteDias'] = vigenciaTramite.get('dias')
        
        expediente_data['vigenciaConcentracionAnios'] = vigenciaConcentracion.get('anios')
        expediente_data['vigenciaConcentracionMeses'] = vigenciaConcentracion.get('meses')
        expediente_data['vigenciaConcentracionDias'] = vigenciaConcentracion.get('dias')
        
        expediente_data['vigenciaTotalAnios'] = vigenciaTotal.get('anios')
        expediente_data['vigenciaTotalMeses'] = vigenciaTotal.get('meses')
        expediente_data['vigenciaTotalDias'] = vigenciaTotal.get('dias')
...
# ============== PRIMERA SECCIÓN ===============
    ...
    directory = os.path.join(BASE_DIR, 'archexpedientes/uridec/pdf_portadas/{}/{}/{}/'.format(actual_year, actual_month, actual_day))
